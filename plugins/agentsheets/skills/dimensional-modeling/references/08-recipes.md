...
breakdowns, id-free. Structure a view cannot spell — per-item overrides,
multi-entry axes, UI-authored drill-ins — is not agent-writable at all
(§11.5): say what the view cannot express and stop.
